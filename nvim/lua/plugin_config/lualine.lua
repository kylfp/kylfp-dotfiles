...
require('lualine').setup {
    options = {
        ...
        theme = {
            ...
            replace = {
                a = {bg = colors.green, fg = colors.bg4, gui = 'bold'},
                b = {bg = colors.bg4, fg = colors.green},
                c = {bg = colors.bg3, fg = colors.green}
            },
            command = {
                a = {bg = colors.red, fg = colors.bg4, gui = 'bold'},
                b = {bg = colors.bg4, fg = colors.red},
                c = {bg = colors.bg3, fg = colors.red}
            },
            inactive = {
